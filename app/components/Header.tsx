...
export default function Header() {
  return (
    <header className="flex h-[10vh] min-h-[60px] max-h-[80px] bg-[var(--background)]  fixed w-full top-0 left-0 font-semibold p-5 bg-whit/40  backdrop-blur-2xl  justify-between items-center ">
